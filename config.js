...
module.exports = {
    ...
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~7uYa4ZnA8uFuMDxuPE90",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "242067712688",
    OWNER_NAME: process.env.OWNER_NAME || "Satoru",
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Satoru +242067712688",
    ...
    AMDIN_EVENTS: process.env.ADMIN_EVENTS || "falsee",
};
